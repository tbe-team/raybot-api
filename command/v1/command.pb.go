...
const (
	...
	CommandStatus_COMMAND_STATUS_CANCELING   CommandStatus = 3
	CommandStatus_COMMAND_STATUS_SUCCEEDED   CommandStatus = 4
	CommandStatus_COMMAND_STATUS_FAILED      CommandStatus = 5
	CommandStatus_COMMAND_STATUS_CANCELED    CommandStatus = 6
)
...
var (
	CommandStatus_name = map[int32]string{
		...
		3: "COMMAND_STATUS_CANCELING",
		4: "COMMAND_STATUS_SUCCEEDED",
		5: "COMMAND_STATUS_FAILED",
		6: "COMMAND_STATUS_CANCELED",
	}
...
const file_command_v1_command_proto_rawDesc = "" +
	...
	"\x12\x15\n" +
	"\x11COMMAND_TYPE_WAIT\x10\v*\xdd\x01\n" +
	...
	"\x18COMMAND_STATUS_CANCELING\x10\x03\x12\x1c\n" +
	"\x18COMMAND_STATUS_SUCCEEDED\x10\x04\x12\x19\n" +
	"\x15COMMAND_STATUS_FAILED\x10\x05\x12\x1b\n" +
	"\x17COMMAND_STATUS_CANCELED\x10\x06*a\n" +
